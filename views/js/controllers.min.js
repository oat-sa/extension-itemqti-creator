...
start:function(){previewLauncher()["catch"](function(err){feedback().error("It seems the preview of the item couldn't be launched : "+err.message)})}};return qtiPreviewIndexController});
